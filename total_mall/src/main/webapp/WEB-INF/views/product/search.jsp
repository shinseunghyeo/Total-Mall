								...
								<c:if test="${not empty productList2[vs.count-1]}"><!-- boardList에 저장된 데이터가 있는 경우 출력-->
				                    <div id="Searchproductbox">
				                        ...
				                        <div id="SearchProduct">
				                            ...
				                            <span class="price bold blue-price">${(productList2[vs.count-1].price-(productList2[vs.count-1].price/100*productList2[vs.count-1].discount_rate)).intValue()}원</span><br>
