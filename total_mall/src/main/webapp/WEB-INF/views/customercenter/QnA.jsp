...
<body>
    ...
    <div id="QnALine">
        ...
        <details>
            ...
            <p>로그인 페이지에서 '아이디/비밀번호 찾기' 링크를 클릭하여 비밀번호를 재설정할 수 있는 페이지로 이동합니다.</p>
        ...
        <details>
            ...
            <p>주로 변경할 수 있는 정보로는 배송지 주소, 연락처, 카테고리 등이 있습니다.</p>
        ...
        <details>
            ...
            <p>신용카드, 체크카드 등 다양한 결제 수단을 제공하고 있습니다.</p>
        ...
        <details>
            ...
            <p>마이 페이지에서 리뷰를 작성할 수 있는 링크를 찾을 수 있습니다.</p>
