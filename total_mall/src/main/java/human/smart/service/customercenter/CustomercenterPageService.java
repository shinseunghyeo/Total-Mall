...
@Service("cPage")
public class CustomercenterPageService implements CustomercenterService {
	//페이지 네비게이션을 위한 9개의 변수에 대한 초기화
	@Override
	public CCPageNav setCCPageNav(CCPageNav pageNav, int pageNum, int pageBlock){
